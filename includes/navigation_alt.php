        ...
        <nav id="menu">
            <ul>
                ...
                <li class="topmenu"><a href="index.php?p=projekte" <?php if ($_GET['p'] == "projekte" || $_GET['p'] == "stadtnaturranger" || $_GET['p'] == "peb") echo " id=\"active\""; ?> >Projects</a>
                    <ul>
                        <li class="submenu"><a href="index.php?p=stadtnaturranger" <?php if ($_GET['p'] == "stadtnaturranger") echo " id=\"active\""; ?> >City Nature<br>Ranger</a></li>
                ...
                <li class="topmenu"><a href="index.php?p=standorte" <?php if ($_GET['p'] == "standorte" || $_GET['p'] == "gartenfelder_str" || $_GET['p'] == "gustav_adolf_str" || $_GET['p'] == "lahnstr_58" || $_GET['p'] == "lahnstr_70") echo " id=\"active\""; ?> >Locations</a>
                    <ul>
            ...
            <ul id="right">
                ...
                <li class="topmenu"><a href="newsfeed.php?p=aktuelles" <?php if ($_GET['p'] == "aktuelles") echo " id=\"active\""; ?> >Current</a></li>
    ...
    <div id="navigation-top">
        ...
        <nav id="menu">
            <ul>
                ...
                <li class="topmenu"><a href="index.php?p=standorte" <?php if ($_GET['p'] == "standorte" || $_GET['p'] == "gartenfelder_str" || $_GET['p'] == "gustav_adolf_str" || $_GET['p'] == "lahnstr_58" || $_GET['p'] == "lahnstr_70") echo " id=\"active\""; ?> >Standorte</a>
                    <ul>
                        <li class="submenu"><a href="index.php?p=standorte" <?php if ($_GET['p'] == "standorte") echo " id=\"active\""; ?> >Storkower</a></li>
                        <li class="submenu"><a href="index.php?p=gartenfelder_str" <?php if ($_GET['p'] == "gartenfelder_str") echo " id=\"active\""; ?> >Gartenfelder</a></li>
                        <li class="submenu"><a href="index.php?p=gustav_adolf_str" <?php if ($_GET['p'] == "gustav_adolf_str") echo " id=\"active\""; ?> >Gustav-Adolf</a></li>
