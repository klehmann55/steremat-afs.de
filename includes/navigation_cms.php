...
if ( isset($_GET['sp']) ) { ?>
    ...
    <nav id="menu">
        ...
        <ul>
            ...
            <li class="topmenu"><a href="cms.php?p=wirüberuns" <?php if ($_GET['p'] == "wirüberuns" || $_GET['p'] == "kernaufgaben" || $_GET['p'] == "leitbild" || $_GET['p'] == "qm") echo " id=\"active\""; ?> >Wir über uns</a>
                <ul>
            ...
            <li class="topmenu"><a href="cms.php?p=angebote" <?php if ($_GET['p'] == "angebote" || $_GET['p'] == "beschaeftigung") echo " id=\"active\""; ?> >Angebote</a>
                <ul>
                    <li class="submenu"><a href="cms.php?p=beschaeftigung" <?php if ($_GET['p'] == "beschaeftigung") echo " id=\"active\""; ?> >Beschäftigung</a></li>
                </ul> 
            </li>
            <li class="topmenu"><a href="cms.php?p=projekte" <?php if ($_GET['p'] == "projekte" || $_GET['p'] == "stadtnaturranger" || $_GET['p'] == "peb") echo " id=\"active\""; ?> >Projekte</a>
                <ul>
            ...
            <li class="topmenu"><a href="cms.php?p=standorte" <?php if ($_GET['p'] == "standorte" || $_GET['p'] == "gartenfelder_str" || $_GET['p'] == "gustav_adolf_str" || $_GET['p'] == "lahnstr") echo " id=\"active\""; ?> >Standorte</a>
                <ul>
                    ...
                    <li class="submenu"><a href="cms.php?p=lahnstr" <?php if ($_GET['p'] == "lahnstr") echo " id=\"active\""; ?> >Lahnstr.</a></li>
                </ul>
            </li>

            
            <li class="topmenu"><a href="cms_newsfeed.php?p=aktuelles" <?php if ($_GET['p'] == "aktuelles") echo " id=\"active\""; ?> >Aktuelles</a></li>
        ...
        <ul id="right">   
            ...
            if ( isset($_GET['d']) && $_GET['d'] == 'dark' || isset($_COOKIE['design']) && $_COOKIE['design'] == 'dark' ) { ?>
                <li class="topmenu"><a href="cms_post.php?p=aktuelles&sp=<?= $_GET['sp']; ?>&d=light" style="background-color: #353739 !important;"><div class="design-button"></div></a></li> 
            <?php }
            elseif ( isset($_GET['d']) && $_GET['d'] == 'light' || isset($_COOKIE['design']) && $_COOKIE['design'] == 'light' ) { ?>
                <li class="topmenu"><a href="cms_post.php?p=aktuelles&sp=<?= $_GET['sp']; ?>&d=dark" style="background-color: white !important;"><div class="design-button"></div></a></li>
            <?php } 
            else { ?>
                <li class="topmenu"><a href="cms_post.php?p=aktuelles&sp=<?= $_GET['sp']; ?>&d=dark" style="background-color: white !important;"><div class="design-button"></div></a></li>
            <?php } ?>
            ...
            <a href="logout.php" style="position:absolute;right:.7rem;top:-2rem;"><input type="button" value="Logout"></a>
        </ul>
...
// NEWSFEED ===================================================================================================================================================================
    ...
    <nav id="menu">
        ...
        <ul id="right">   
            ...
            <?php 
            if ( isset($_GET['d']) && $_GET['d'] == 'dark' || isset($_COOKIE['design']) && $_COOKIE['design'] == 'dark' ) { ?>
                <li class="topmenu"><a href="cms_newsfeed.php?p=aktuelles&d=light" style="background-color: #353739 !important;"><div class="design-button"></div></a></li> 
            <?php }
            elseif ( isset($_GET['d']) && $_GET['d'] == 'light' || isset($_COOKIE['design']) && $_COOKIE['design'] == 'light' ) { ?>
                <li class="topmenu"><a href="cms_newsfeed.php?p=aktuelles&d=dark" style="background-color: white !important;"><div class="design-button"></div></a></li>
            <?php } 
            else { ?>
                <li class="topmenu"><a href="cms_newsfeed.php?p=aktuelles&d=dark" style="background-color: white !important;"><div class="design-button"></div></a></li>
            <?php } ?>
    ...
    <div id="navigation-top">
        ...
        <nav id="menu">
            ...
            <a href="cms.php">
                ...
                <li class="topmenu"><a href="cms.php?p=wirüberuns" <?php if ($_GET['p'] == "wirüberuns" || $_GET['p'] == "kernaufgaben" || $_GET['p'] == "leitbild" || $_GET['p'] == "qm") echo " id=\"active\""; ?> >About Us</a>
                    <ul>
                ...
                <li class="topmenu"><a href="cms.php?p=angebote" <?php if ($_GET['p'] == "angebote" || $_GET['p'] == "beschaeftigung") echo " id=\"active\""; ?> >Offers</a>
                    <ul>
                        <li class="submenu"><a href="cms.php?p=beschaeftigung" <?php if ($_GET['p'] == "beschaeftigung") echo " id=\"active\""; ?> >Activity</a></li>
                    </ul> 
                </li>
                <li class="topmenu"><a href="cms.php?p=projekte" <?php if ($_GET['p'] == "projekte" || $_GET['p'] == "stadtnaturranger" || $_GET['p'] == "peb") echo " id=\"active\""; ?> >Projects</a>
                    <ul>
                        <li class="submenu"><a href="cms.php?p=stadtnaturranger" <?php if ($_GET['p'] == "stadtnaturranger") echo " id=\"active\""; ?> >Stadtnatur-<br>ranger</a></li>
                        <li class="submenu"><a href="cms.php?p=peb" <?php if ($_GET['p'] == "peb") echo " id=\"active\""; ?> >PEB</a></li>
                    </ul>  
                ...
                <li class="topmenu"><a href="cms.php?p=standorte" <?php if ($_GET['p'] == "standorte" || $_GET['p'] == "gartenfelder_str" || $_GET['p'] == "gustav_adolf_str" || $_GET['p'] == "lahnstr" ) echo " id=\"active\""; ?> >Locations</a>
                    <ul>
                        <li class="submenu"><a href="cms.php?p=standorte" <?php if ($_GET['p'] == "standorte") echo " id=\"active\""; ?> >Storkower</a></li>
                        <li class="submenu"><a href="cms.php?p=gartenfelder_str" <?php if ($_GET['p'] == "gartenfelder_str") echo " id=\"active\""; ?> >Gartenfelder</a></li>
                        <li class="submenu"><a href="cms.php?p=gustav_adolf_str" <?php if ($_GET['p'] == "gustav_adolf_str") echo " id=\"active\""; ?> >Gustav-Adolf</a></li>
                ...
                <li class="topmenu"><a href="cms_newsfeed.php?p=aktuelles" <?php if ($_GET['p'] == "aktuelles") echo " id=\"active\""; ?> >Actual</a></li>
            </ul> 
            ...
            <ul id="right">   
                ...
                <?php 
            if ( isset($_GET['d']) && $_GET['d'] == 'dark' || isset($_COOKIE['design']) && $_COOKIE['design'] == 'dark' ) { ?>
                <li class="topmenu"><a href="cms.php?p=<?= $_GET['p']; ?>&d=light" style="background-color: #353739 !important;"><div class="design-button"></div></a></li> 
            <?php }
            elseif ( isset($_GET['d']) && $_GET['d'] == 'light' || isset($_COOKIE['design']) && $_COOKIE['design'] == 'light' ) { ?>
                <li class="topmenu"><a href="cms.php?p=<?= $_GET['p']; ?>&d=dark" style="background-color: white !important;"><div class="design-button"></div></a></li> 
            <?php } 
            else { ?>
                <li class="topmenu"><a href="cms.php?p=<?= $_GET['p']; ?>&d=dark" style="background-color: white !important;"><div class="design-button"></div></a></li> 
            <?php } ?>

            <li class="topmenu"><a href="cms.php?p=<?= $_GET['p']; ?>&l=de">DEU</a></li>
        ...
        <nav id="menu">
            ...
            <ul id="right">   
                ...
                if ( isset($_GET['ls']) && $_GET['ls'] == 'true' || isset($_COOKIE['ls']) && $_COOKIE['ls'] == 'true') { ?>
                    <li class="topmenu"><a href="cms.php?p=<?= $_GET['p']; ?>&ls=false" <?php if ( isset($_GET['ls']) && $_GET['ls'] == "true" || isset($_COOKIE['ls']) && $_COOKIE['ls'] == "true" ) echo " id=\"active\""; ?> >LEICHTE SPRACHE</a></li>
                <?php }
                else { ?>
                    <li class="topmenu"><a href="cms.php?p=<?= $_GET['p']; ?>&ls=true" <?php if ( isset($_GET['ls']) && $_GET['ls'] == "true" || isset($_COOKIE['ls']) && $_COOKIE['ls'] == "true" ) echo " id=\"active\""; ?> >LEICHTE SPRACHE</a></li>
                <?php } ?>
                ...
                <li class="topmenu"><a href="cms.php?p=<?= $_GET['p']; ?>&l=en">ENG</a></li>
